...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_bidang', 'daftar_bidang']) ? 'active' : '' ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBidang" aria-expanded="true" aria-controls="collapseBidang">
    ...
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_jabatan', 'daftar_jabatan']) ? 'active' : '' ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseJabatan" aria-expanded="true" aria-controls="collapseJabatan">
    ...
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_karyawan', 'daftar_karyawan']) ? 'active' : '' ?>">
        ...
        <div id="collapseKaryawan" class="collapse <?= in_array(strtolower($active_sidebar), ['tambah_karyawan', 'daftar_karyawan']) ? 'show' : '' ?>" aria-labelledby="headingKaryawan" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Karyawan:</h6> -->
                <a class="collapse-item <?= strtolower($active_sidebar) == 'tambah_karyawan' ? 'active' : '' ?>" href="tambah_karyawan.html">Tambah Karyawan</a>
                <a class="collapse-item <?= strtolower($active_sidebar) == 'daftar_karyawan' ? 'active' : '' ?>" href="daftar_karyawan.html">Daftar Karyawan</a>
            </div>
        </div>
    </li>

    <!-- Nav Item - Jabatan Collapse Menu -->
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_absensi', 'daftar_absensi']) ? 'active' : '' ?>">
    ...
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_pekerjaan', 'daftar_pekerjaan']) ? 'active' : '' ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePekerjaan" aria-expanded="true" aria-controls="collapsePekerjaan">
    ...
    <!-- Nav Item - Kegiatan -->
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_bidang', 'daftar_bidang']) ? 'active' : '' ?>">
        <a class="nav-link" href="kegiatan.html">
    ...
    <li class="nav-item <?= in_array(strtolower($active_sidebar), ['tambah_bidang', 'daftar_bidang']) ? 'active' : '' ?>">
        <a class="nav-link" href="perkembangan.html">
